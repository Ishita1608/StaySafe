            ...
            content: SingleChildScrollView(
              child: ListBody(
                children: <Widget>[
                  ...
                  Text("Foreigner Cases :$inter",style: TextStyle(fontSize: 25,color : Colors.black),),
                                      ...
                                      child : Center(
                                        child: Column(
                                            ...
                                            children : <Widget>[
                                              ...
                                              Image(image: AssetImage("assests/cases1.png"),
                                                height: 100,
                                                width: 100
                                                ,),

                                              Flexible(child: Text(snapshot.data[index]['loc'],style: TextStyle(fontSize: 15,color: Colors.white),)),
